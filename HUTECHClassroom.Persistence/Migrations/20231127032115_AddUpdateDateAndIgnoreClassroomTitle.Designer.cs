...
namespace HUTECHClassroom.Persistence.Migrations
{
    ...
    [Migration("20231127032115_AddUpdateDateAndIgnoreClassroomTitle")]
    partial class AddUpdateDateAndIgnoreClassroomTitle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HUTECHClassroom.Domain.Entities.ScoreType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HUTECHClassroom.Domain.Entities.StudentResult", b =>
                {
                    ...
                    b.HasKey("StudentId", "ClassroomId", "ScoreTypeId");
            ...
            modelBuilder.Entity("HUTECHClassroom.Domain.Entities.Photo", b =>
                {
                    b.HasOne("HUTECHClassroom.Domain.Entities.ApplicationUser", "User")
                        .WithOne("Avatar")
                        .HasForeignKey("HUTECHClassroom.Domain.Entities.Photo", "UserId");
            ...
            modelBuilder.Entity("HUTECHClassroom.Domain.Entities.StudentResult", b =>
                {
                    ...
                    b.HasOne("HUTECHClassroom.Domain.Entities.ScoreType", "ScoreType")
                        .WithMany()
