...
public sealed record GetMajorsWithPaginationQuery(MajorPaginationParams Params) : GetWithPaginationQuery<MajorDTO, MajorPaginationParams>(Params);
public sealed class GetMajorsWithPaginationQueryHandler : GetWithPaginationQueryHandler<Major, GetMajorsWithPaginationQuery, MajorDTO, MajorPaginationParams>
{
    ...
    protected override IQuery<Major> Order(IMultipleResultQuery<Major> query)
