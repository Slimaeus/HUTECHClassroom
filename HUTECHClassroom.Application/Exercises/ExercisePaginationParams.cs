...
public record ExercisePaginationParams(Guid? UserId, int? PageNumber, int? PageSize, string? SearchString) : UserPaginationParams(PageNumber, PageSize, SearchString, UserId)
{
