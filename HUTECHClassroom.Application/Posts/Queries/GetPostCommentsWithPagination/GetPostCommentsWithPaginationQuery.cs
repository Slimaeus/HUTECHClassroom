...
public sealed record GetPostCommentsWithPaginationQuery(Guid Id, PostPaginationParams Params) : GetWithPaginationQuery<CommentDTO, PostPaginationParams>(Params);
public sealed class GetPostCommentsWithPaginationQueryHandler : GetWithPaginationQueryHandler<Comment, GetPostCommentsWithPaginationQuery, CommentDTO, PostPaginationParams>
{
    ...
    protected override Expression<Func<Comment, bool>> FilterPredicate(GetPostCommentsWithPaginationQuery query)
        => x => x.PostId == query.Id && (query.Params.UserId == null || query.Params.UserId == Guid.Empty || query.Params.UserId == x.UserId);
