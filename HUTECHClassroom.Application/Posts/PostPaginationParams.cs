...
public record PostPaginationParams(int? PageNumber, int? PageSize, string SearchString, Guid? UserId) : PaginationParams(PageNumber, PageSize, SearchString, UserId)
{
