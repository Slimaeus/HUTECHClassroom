...
public class GetSubjectsWithPaginationQueryHandler : GetWithPaginationQueryHandler<string, Subject, GetSubjectsWithPaginationQuery, SubjectDTO, SubjectPaginationParams>
{
