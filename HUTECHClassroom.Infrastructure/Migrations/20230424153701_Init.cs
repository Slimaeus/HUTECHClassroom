    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Deadline = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValue: new DateTime(2023, 4, 25, 15, 37, 1, 85, DateTimeKind.Utc).AddTicks(6303)),
                Topic = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
