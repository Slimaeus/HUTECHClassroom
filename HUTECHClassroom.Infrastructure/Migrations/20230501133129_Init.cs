    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Deadline = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValue: new DateTime(2023, 5, 2, 13, 31, 29, 792, DateTimeKind.Utc).AddTicks(7700)),
                Topic = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
